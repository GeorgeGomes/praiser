...
<div style="background-color: #000000; width: 100%;padding:1em;color:#ffffff">
	<div style="font-size: 2em; float: left;width:3em"><a href="/praizer/" style="color:#ffffff">Praizer</a></div>
	
	<div style="margin-left:1em;float: right;;width:18em;border-left:1px solid #ffffff;margin-top:1em;">
